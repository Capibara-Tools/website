...
import code from "../resources/code-complete.png"
...
export default function Home() {
    return (
        ...
        <div className="page">
            <p className="text">
                Capibara is crowd-sourced C library documentation and plugins for your favorite editors like VS Code, Vim, etc.
